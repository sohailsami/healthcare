...
class _OtpScreenState extends State<OtpScreen> with SingleTickerProviderStateMixin {
  ...
  get _getVerificationTitleLabel {
    return new Text(
      ...
      style: new TextStyle(
          fontSize: 28.0, color: kBaseColor, fontWeight: FontWeight.bold),
    );
  }
  ...
  get _getVerificationDescLabel {
    return new Text(
      ...
      textAlign: TextAlign.center,
      style: new TextStyle(
          fontSize: 18.0, color: kBaseColor, fontWeight: FontWeight.w600),
    );
  }
    ...
    return new InkWell(
      child: new Container(
        ...
        child: new Text(
          "Verify",
          style:
          new TextStyle(fontFamily: 'Poppins-Bold', color: Colors.white),
        ),
      ),
      onTap: () {
